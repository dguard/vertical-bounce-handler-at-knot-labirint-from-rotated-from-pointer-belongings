...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-labirint-from-rotated']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-labirint-from-rotated']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-labirint-from-rotated'] = {}
    // keep

    passThrough['@pencil/draft-knot-labirint-from-rotated'] = function (spawnedPointerBelongings) {
...
// keep !
passThroughFromBottom['@pencil/draft-knot-labirint-from-rotated']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-labirint-from-rotated']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-labirint-from-rotated']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-labirint-from-rotated']['canvas'] = ctx
...
// keep
let knot1 = draftFabrikk.constructKnotFromRotated(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 4, 1 * 4 * 1.2, 1 * 4 * 1.7 * 1.1)
pencil.useKnot(knot1)

// keep !
// spawnedPointerBelongingsAtRotatedKnotFromBottomStatement

// keep !
let spawnedPointerBelongingsAtRotatedKnotFromBottomStatement = { rotating: 0.95 }
pencil.useRotatedKnot(knot1, spawnedPointerBelongingsAtRotatedKnotFromBottomStatement)

let debthPointerBelongingsAtRotated = {}
pencil.useRotatedKnotAtDebth(knot1, debthPointerBelongingsAtRotated)
...
// keep
window['@pencil/draft-knot-labirint-from-rotated'] = {
    passThrough: passThrough['@pencil/draft-knot-labirint-from-rotated'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-labirint-from-rotated']
}
// keep
